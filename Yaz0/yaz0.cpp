...
#define U32(x)  ((u32)( (((u8*)(x))[0]<<24)|(((u8*)(x))[1]<<16)|(((u8*)(x))[2]<<8)|((u8*)(x))[3] ))
#define U16(x)  ((unsigned short)( ((*((u8*)(x)))<<8)|((u8*)(x))[1] ))
#define U8(x)	((u8)((u8*)(x))[0])
...
u32 yaz0_decode_internal(u8 *src, u8 *dst, int uncompressedSize);
